...
static void setup_mmu()
{
	...
	/* Identity mapping. */
	// [0] 00 0000 0000 - 00 3FFF FFFF
	lvl1_table[0] = TT_S1_NORMAL_NO_CACHE |
			TT_S1_INNER_SHARED |
			(uint64_t) 0x0;
	
	/* [1]: 0x00 4000,0000 - 0x00 7FFF,FFFF */
	lvl1_table[1] = TT_S1_NORMAL_NO_CACHE |
			TT_S1_INNER_SHARED |
			(uint64_t) 0x40000000;

	/* [2]: 0x00 8000,0000 - 0x00 BFFF,FFFF */
	lvl1_table[2] = TT_S1_NORMAL_NO_CACHE |
			TT_S1_INNER_SHARED |
			(uint64_t) 0x80000000;

	/* [3]: 0x00 C000,0000 - 0x00 FFFF,FFFF */
	...
	/* Temporary kernel vaspace mapping. */
